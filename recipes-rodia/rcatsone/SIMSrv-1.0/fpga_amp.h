/*
 *
 *  Copyright (c) 2016 RCATSOne Incorporated.  All rights reserved.
 *
 */
// fpga_amp.h
//
...
#define AMP_SSW_IRQ                 (0x22)

#define AMP_PH_SIM                  (0x24)
#define AMP_PH_SCR                  (0x25)
#define AMP_PH_EVENT_IER            (0x26)
#define AMP_RCON_ADR                (0x28)
#define AMP_RCON_SCR                (0x29)

#define FPGA_AMP_SSW_IRQ            (FPGA_AMP_REG_BASE + AMP_SSW_IRQ)

#define FPGA_AMP_PH_SIM             (FPGA_AMP_REG_BASE + AMP_PH_SIM)
#define FPGA_AMP_PH_SCR             (FPGA_AMP_REG_BASE + AMP_PH_SCR)
#define FPGA_AMP_PH_EVENT_IER       (FPGA_AMP_REG_BASE + AMP_PH_EVENT_IER)
#define FPGA_AMP_RCON_ADR           (FPGA_AMP_REG_BASE + AMP_RCON_ADR)
#define FPGA_AMP_RCON_SCR           (FPGA_AMP_REG_BASE + AMP_RCON_SCR)

#if 0
#define AMP_UART_BASE               (0x30)
#define FPGA_AMP_UART_BASE          (FPGA_AMP_REG_BASE + AMP_UART_BASE)
...
#define FPGA_AMP_SSW_IRQ_PH0            (1<<0)
#define FPGA_AMP_SSW_IRQ_PH1            (1<<1)
#define FPGA_AMP_SSW_IRQ_PH2            (1<<2)
#define FPGA_AMP_SSW_IRQ_UART0          (1<<4)
#define FPGA_AMP_SSW_IRQ_UART1          (1<<5)
#define FPGA_AMP_SSW_IRQ_UART2          (1<<6)

#define FPGA_AMP_LPH_SCR_SIM_PRESENT    (1<<0)
#define FPGA_AMP_LPH_SCR_VCC_1_8V       (1<<1)
#define FPGA_AMP_LPH_SCR_VCC_3_0V       (1<<2)
#define FPGA_AMP_LPH_SCR_VCC_5_0V       (FPGA_LPH_SCR_VCC_1_8V|FPGA_LPH_SCR_VCC_3_0V)
#define FPGA_AMP_LPH_SCR_VCC_STATUS     FPGA_LPH_SCR_VCC_5_0V
#define FPGA_AMP_LPH_SCR_VCC_LVL_ERR    (1<<3)
#define FPGA_AMP_LPH_SCR_RST_STATUS     (1<<5)
#define FPGA_AMP_LPH_SCR_DELTA_VCC      (1<<6)
#define FPGA_AMP_LPH_SCR_DELTA_RST      (1<<7)

#define FPGA_AMP_LPH_VCC_INT_EN         (1<<0)
#define FPGA_AMP_LPH_RST_INT_EN         (1<<1)

#define FPGA_AMP_RC_SCR_CLK_EN          (1<<2)
#define FPGA_AMP_RC_SCR_MON_EN          (1<<6)
#define FPGA_AMP_RC_SCR_SIM_SIDE        (1<<7)

#define IIR_AMP_RCV_FIFO_ENABLE         (0x01)
#endif
